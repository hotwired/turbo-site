...
<html lang="en">
  ...
  <title>Turbo Reference: Attributes</title>
  <meta name="description" content="A reference of everything you can do with element attributes and meta tags.">
  <link rel="canonical" href="https://turbo.hotwired.dev/reference/attributes">
...
<div class="nav__github-corner">
  <svg width="60" height="60" viewBox="0 0 250 250" version="1.1" xmlns="github-corner"
	...
	aria-hidden="true">
	<a href="https://github.com/hotwired/turbo-site/blob/main/./_source/reference/attributes.md" target="_blank" class="github-corner">
...
<nav class="nav">
  ...
  <ul class="nav__list ">
    ...
    <li>
      ...
      <a class="nav__sublist-link active" href="/reference/attributes">Attributes
      </a>
    </li></ul>
  ...
  <section id="content" class="docs__content grid__custom-item">
    ...
    <h1>Attributes and Meta Tags</h1>
<h2 id="data-attributes" tabindex="-1"><a class="anchor" href="#data-attributes">﹟</a> Data Attributes</h2>
<p>The following data attributes can be applied to elements to customize Turbo’s behaviour.</p>
<ul>
<li><code>data-turbo=&quot;false&quot;</code> disables Turbo Drive on links and forms including descendants. To reenable when an ancestor has opted out, use <code>data-turbo=&quot;true&quot;</code>. Be careful: when Turbo Drive is disabled, browsers treat link clicks as normal, but <a href="/handbook/native">native adapters</a> may exit the app. Note that if Turbo <a href="/handbook/drive#ignored-paths">ignores a path</a>, then setting <code>data-turbo=&quot;true&quot;</code> will not force/override it to enable.</li>
<li><code>data-turbo-track=&quot;reload&quot;</code> tracks the element’s HTML and performs a full page reload when it changes. Typically used to <a href="/handbook/drive#reloading-when-assets-change">keep <code>script</code> and CSS <code>link</code> elements up-to-date</a>.</li>
<li><code>data-turbo-track=&quot;dynamic&quot;</code> tracks the element’s HTML and removes the element when it is absent from an HTML response. Typically used to <a href="/handbook/drive#removing-assets-when-they-change">remove <code>style</code> and <code>link</code> elements</a> during navigation.</li>
<li><code>data-turbo-frame</code> identifies the Turbo Frame to navigate. Refer to the <a href="/reference/frames">Frames documentation</a> for further details.</li>
<li><code>data-turbo-preload</code> signals to <a href="/handbook/drive#preload-links-into-the-cache">Drive</a> to pre-fetch the next page’s content</li>
<li><code>data-turbo-prefetch=&quot;false&quot;</code> <a href="/handbook/drive#prefetching-links-on-hover">disables prefetching links</a> when the element is hovered.</li>
<li><code>data-turbo-action</code> customizes the <a href="/handbook/drive#page-navigation-basics">Visit</a> action. Valid values are <code>replace</code> or <code>advance</code>. Can also be used with Turbo Frames to <a href="/handbook/frames#promoting-a-frame-navigation-to-a-page-visit">promote frame navigations to page visits</a>.</li>
<li><code>data-turbo-permanent</code> <a href="/handbook/building#persisting-elements-across-page-loads">persists the element between page loads</a>. The element must have a unique <code>id</code> attribute. It also serves to exclude elements from being morphed when using <a href="/handbook/page_refreshes.html">page refreshes with morphing</a></li>
<li><code>data-turbo-temporary</code> removes the element before the document is cached, preventing it from reappearing when restored.</li>
<li><code>data-turbo-eval=&quot;false&quot;</code> prevents inline <code>script</code> elements from being re-evaluated on Visits.</li>
<li><code>data-turbo-method</code> changes the link request type from the default <code>GET</code>. Ideally, non-<code>GET</code> requests should be triggered with forms, but <code>data-turbo-method</code> might be useful where a form is not possible.</li>
<li><code>data-turbo-stream</code> specifies that a link or form can accept a Turbo Streams response. Turbo <a href="/handbook/streams#streaming-from-http-responses">automatically requests stream responses</a> for form submissions with non-<code>GET</code> methods; <code>data-turbo-stream</code> allows Turbo Streams to be used with <code>GET</code> requests as well.</li>
<li><code>data-turbo-confirm</code> presents a confirm dialog with the given value. Can be used on <code>form</code> elements or links with <code>data-turbo-method</code>.</li>
<li><code>data-turbo-submits-with</code> specifies text to display when submitting a form. Can be used on <code>input</code> or <code>button</code> elements. While the form is submitting the text of the element will show the value of <code>data-turbo-submits-with</code>. After the submission, the original text will be restored. Useful for giving user feedback by showing a message like “Saving…” while an operation is in progress.</li>
<li><code>download</code> opts out of Turbo since the link is for downloading files and not navigation.</li>
</ul>
<h2 id="automatically-added-attributes" tabindex="-1"><a class="anchor" href="#automatically-added-attributes">﹟</a> Automatically Added Attributes</h2>
<p>The following attributes are automatically added by Turbo and are useful to determine the Visit state at a given moment.</p>
<ul>
...
<li><code>aria-busy</code> is added to:
<ul>
<li>the <code>html</code> element when a visit is in progress</li>
<li>the <code>form</code> element when a submission is in progress.</li>
<li>the <code>turbo-frame</code> element when a visit or form submission is in progress within the frame.</li>
</ul>
</li>
<li><code>busy</code> is added to the <code>turbo-frame</code> element when a navigation or form submission is in progress within the frame.</li>
</ul>
<h2 id="meta-tags" tabindex="-1"><a class="anchor" href="#meta-tags">﹟</a> Meta Tags</h2>
<p>The following <code>meta</code> elements, added to the <code>head</code>, can be used to customize caching and Visit behavior.</p>
<ul>
...
<li><code>&lt;meta name=&quot;turbo-prefetch&quot; content=&quot;false&quot;&gt;</code> will disable <a href="/handbook/drive#prefetching-links-on-hover">prefetching links on hover</a>.</li>
</ul>
</section>
