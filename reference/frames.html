...
<html lang="en">
  ...
  <title>Turbo Reference</title>
  <meta name="description" content="A reference of everything you can do with Turbo Frames.">
  <link rel="canonical" href="https://turbo.hotwired.dev/reference/frames">
...
<div class="nav__github-corner">
  <svg width="60" height="60" viewBox="0 0 250 250" version="1.1" xmlns="github-corner"
	...
	aria-hidden="true">
	<a href="https://github.com/hotwired/turbo-site/blob/main/./_source/reference/frames.md" target="_blank" class="github-corner">
...
<nav class="nav">
  ...
  <ul class="nav__list ">
    ...
    <li>
      <a class="nav__list-link active" href="/reference/drive">Reference</a>

      <ul class="nav__sublist  active"><li>
      <a class="nav__sublist-link" href="/reference/drive">Drive
      </a>
    </li><li>
      <a class="nav__sublist-link active" href="/reference/frames">Frames
      </a>
    </li><li>
  ...
  <section id="content" class="docs__content grid__custom-item">
    ...
    <h1>Frames</h1>
<h2 id="basic-frame" tabindex="-1"><a class="anchor" href="#basic-frame">﹟</a> Basic frame</h2>
<p>Confines all navigation within the frame by expecting any followed link or form submission to return a response including a matching frame tag:</p>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages/expanded<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Show all expanded messages in this frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>

  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>form</span> <span class="token attr-name">action</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Show response from this form within this frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="eager-loaded-frame" tabindex="-1"><a class="anchor" href="#eager-loaded-frame">﹟</a> Eager-loaded frame</h2>
<p>Works like the basic frame, but the content is loaded from a remote <code>src</code> first.</p>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  Content will be replaced when /messages has been loaded.
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="lazy-loaded-frame" tabindex="-1"><a class="anchor" href="#lazy-loaded-frame">﹟</a> Lazy-loaded frame</h2>
<p>Like an eager-loaded frame, but the content is not loaded from <code>src</code> until the frame is visible.</p>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages<span class="token punctuation">"</span></span> <span class="token attr-name">loading</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>lazy<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  Content will be replaced when the frame becomes visible and /messages has been loaded.
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="frame-targeting-the-whole-page-by-default" tabindex="-1"><a class="anchor" href="#frame-targeting-the-whole-page-by-default">﹟</a> Frame targeting the whole page by default</h2>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span> <span class="token attr-name">target</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>_top<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages/1<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Following link will replace the whole page, not this frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>

  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages/1<span class="token punctuation">"</span></span> <span class="token attr-name">data-turbo-frame</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>_self<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="frame-with-overwritten-navigation-targets" tabindex="-1"><a class="anchor" href="#frame-with-overwritten-navigation-targets">﹟</a> Frame with overwritten navigation targets</h2>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages/1<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Following link will replace this frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>

  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages/1<span class="token punctuation">"</span></span> <span class="token attr-name">data-turbo-frame</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>_top<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Following link will replace the whole page, not this frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>

  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>form</span> <span class="token attr-name">action</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages<span class="token punctuation">"</span></span> <span class="token attr-name">data-turbo-frame</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>navigation<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    Submitting form will replace the navigation frame.
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="frame-that-promotes-navigations-to-visits" tabindex="-1"><a class="anchor" href="#frame-that-promotes-navigations-to-visits">﹟</a> Frame that promotes navigations to Visits</h2>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>messages<span class="token punctuation">"</span></span> <span class="token attr-name">data-turbo-action</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>advance<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages?page=2<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Advance history to next page<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/messages?page=2<span class="token punctuation">"</span></span> <span class="token attr-name">data-turbo-action</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>replace<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Replace history with next page<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h2 id="frame-that-will-get-reloaded-with-morphing-during-page-refreshes-%26-when-they-are-explicitly-reloaded-with-.reload()" tabindex="-1"><a class="anchor" href="#frame-that-will-get-reloaded-with-morphing-during-page-refreshes-%26-when-they-are-explicitly-reloaded-with-.reload()">﹟</a> Frame that will get reloaded with morphing during page refreshes &amp; when they are explicitly reloaded with .reload()</h2>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>my-frame<span class="token punctuation">"</span></span> <span class="token attr-name">refresh</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>morph<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>/my_frame<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<h1>Attributes, properties, and functions</h1>
<p>The <code>&lt;turbo-frame&gt;</code> element is a <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements">custom element</a> with its own set of HTML
attributes and JavaScript properties.</p>
<h2 id="html-attributes" tabindex="-1"><a class="anchor" href="#html-attributes">﹟</a> HTML Attributes</h2>
<ul>
<li>
<p><code>src</code> accepts a URL or path value that controls navigation
of the element</p>
</li>
<li>
<p><code>loading</code> has two valid <a href="https://www.w3.org/TR/html52/infrastructure.html#keywords-and-enumerated-attributes">enumerated</a> values: “eager” and “lazy”. When
<code>loading=&quot;eager&quot;</code>, changes to the <code>src</code> attribute will immediately navigate
the element. When <code>loading=&quot;lazy&quot;</code>, changes to the <code>src</code> attribute will defer
navigation until the element is visible in the viewport. The default value is <code>eager</code>.</p>
</li>
<li>
<p><code>busy</code> is a <a href="https://www.w3.org/TR/html52/infrastructure.html#sec-boolean-attributes">boolean attribute</a> toggled to be present when a
<code>&lt;turbo-frame&gt;</code>-initiated request starts, and toggled false when the request
ends</p>
</li>
<li>
<p><code>disabled</code> is a <a href="https://www.w3.org/TR/html52/infrastructure.html#sec-boolean-attributes">boolean attribute</a> that prevents any navigation when
present</p>
</li>
<li>
<p><code>target</code> refers to another <code>&lt;turbo-frame&gt;</code> element by ID to be navigated when
a descendant <code>&lt;a&gt;</code> is clicked. When <code>target=&quot;_top&quot;</code>, navigate the window.</p>
</li>
<li>
<p><code>complete</code> is a boolean attribute whose presence or absence indicates whether
or not the <code>&lt;turbo-frame&gt;</code> element has finished navigating.</p>
</li>
<li>
<p><code>recurse</code> allows the <code>&lt;turbo-frame&gt;</code> to load content that contains another nested
frame. <code>recurse</code> refers to another <code>&lt;turbo-frame&gt;</code> element by ID, present in the
...
frame that can load the target frame.</p>
<p>For example, imagine <code>/frames.html</code> contains:</p>
</li>
</ul>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>recursive<span class="token punctuation">"</span></span> <span class="token attr-name">recurse</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>composer<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>recursive.html<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<p>And <code>recursive.html</code> contains:</p>
<pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>recursive<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>turbo-frame</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>composer<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>frames.html<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Link<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>turbo-frame</span><span class="token punctuation">></span></span></code></pre>
<p>When <code>Link</code> navigates back to <code>frames.html</code>, Turbo needs to find the frame with ID <code>composer</code>
in the response to update the current <code>composer</code> frame. Since there’s no such frame in
<code>frames.html</code> directly, Turbo finds the frame with <code>recurse=&quot;composer&quot;</code>, activates it to load
its <code>src</code> (<code>recursive.html</code>), then searches for and extracts the <code>composer</code> frame from that
loaded content to update the original frame.</p>
<ul>
<li><code>autoscroll</code> is a <a href="https://www.w3.org/TR/html52/infrastructure.html#sec-boolean-attributes">boolean attribute</a> that controls whether or not to scroll
a <code>&lt;turbo-frame&gt;</code> element (and its descendant <code>&lt;turbo-frame&gt;</code> elements) into
view after loading. Control the scroll’s vertical alignment by setting the
<code>data-autoscroll-block</code> attribute to a valid <a href="https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollIntoView#parameters">Element.scrollIntoView({ block:
“…” })</a> value: one of <code>&quot;end&quot;</code>, <code>&quot;start&quot;</code>, <code>&quot;center&quot;</code>,
or <code>&quot;nearest&quot;</code>. When <code>data-autoscroll-block</code> is absent, the default value is
<code>&quot;end&quot;</code>. Control the scroll’s behavior by setting the
<code>data-autoscroll-behavior</code> attribute to a valid <a href="https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollIntoView#parameters">Element.scrollIntoView({
behavior:
“…” })</a> value: one of <code>&quot;auto&quot;</code>, or <code>&quot;smooth&quot;</code>.
When <code>data-autoscroll-behavior</code> is absent, the default value is <code>&quot;auto&quot;</code>.</li>
</ul>
<h2 id="properties" tabindex="-1"><a class="anchor" href="#properties">﹟</a> Properties</h2>
<p>All <code>&lt;turbo-frame&gt;</code> elements can be controlled in JavaScript environments
through instances of the <code>FrameElement</code> class.</p>
<ul>
<li>
<p><code>FrameElement.src</code> controls the pathname or URL to be loaded. Setting the <code>src</code>
property will immediately navigate the element. When <code>FrameElement.loaded</code> is
set to <code>&quot;lazy&quot;</code>, changes to the <code>src</code> property will defer navigation until the
element is visible in the viewport.</p>
</li>
<li>
<p><code>FrameElement.disabled</code> is a boolean property that controls whether or not the
element will load</p>
</li>
<li>
<p><code>FrameElement.loading</code> controls the style (either <code>&quot;eager&quot;</code> or <code>&quot;lazy&quot;</code>) that
the frame will loading its content.</p>
</li>
<li>
<p><code>FrameElement.loaded</code> references a <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a> instance that resolves once the
<code>FrameElement</code>’s current navigation has completed.</p>
</li>
<li>
<p><code>FrameElement.complete</code> is a read-only boolean property set to <code>true</code> when the
<code>FrameElement</code> has finished navigating and <code>false</code> otherwise.</p>
</li>
<li>
<p><code>FrameElement.autoscroll</code> controls whether or not to scroll the element into
view once loaded</p>
</li>
<li>
<p><code>FrameElement.isActive</code> is a read-only boolean property that indicates whether
or not the frame is loaded and ready to be interacted with</p>
</li>
<li>
<p><code>FrameElement.isPreview</code> is a read-only boolean property that returns <code>true</code>
when the <code>document</code> that contains the element is a <a href="https://turbo.hotwired.dev/handbook/building#detecting-when-a-preview-is-visible">preview</a>.</p>
</li>
</ul>
<h2 id="functions" tabindex="-1"><a class="anchor" href="#functions">﹟</a> Functions</h2>
<ul>
<li><code>FrameElement.reload()</code> is a function that reloads the frame element from its <code>src</code>.</li>
</ul>
<p><a class="button" href="/reference/streams">Next: Streams</a></p></section>
